...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[48] = {
	...
	{(const void *)0x25279, (ISR)0x3433d}, /* 41 */
	...
	{(const void *)0x25a25, (ISR)0x3433d}, /* 47 */
};
